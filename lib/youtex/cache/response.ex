defprotocol Youtex.Cache.Response do
  @moduledoc """
...
defimpl Youtex.Cache.Response, for: Tuple do
...
defimpl Youtex.Cache.Response, for: Atom do
  def format(nil), do: {:miss, nil}
  def format(:ok), do: {:ok, :ok}
  def format(atom), do: {:ok, atom}
end

defimpl Youtex.Cache.Response, for: Any do
  def format(nil), do: {:miss, nil}
